...
local function R_W1_Post_Jet_Run()
    ...
    if hit and hit.gen == GEN then return hit.v end
    local v = ALL(HAS("jetrunbadge"), R_W1_Post_Bulrush_Express())
...
local function R_W6_Post_Spring()
    ...
    if hit and hit.gen == GEN then return hit.v end
    local v = ALL(HAS("jetrunbadge"), R_W6_25_Seeds())
...
LOC["14887805044"] = function() return ALL(R_W6_Start(), ANY(HAS("w2wonderseed"), smbw_cat(1, "daisy", "yellowtoad", "bluetoad", "toadette"))) end
LOC["14887805045"] = function() return ALL(R_W6_Start(), ANY(HAS("w2wonderseed"), smbw_cat(1, "daisy", "yellowtoad", "bluetoad", "toadette"))) end
LOC["14887805046"] = function() return ALL(R_W6_Start(), ANY(HAS("w2wonderseed"), smbw_cat(1, "daisy", "yellowtoad", "bluetoad", "toadette"))) end
LOC["14887805047"] = function() return ALL(R_W6_Start(), ANY(HAS("w2wonderseed"), smbw_cat(1, "daisy", "yellowtoad", "bluetoad", "toadette"))) end
LOC["14887805048"] = function() return ALL(R_W6_Start(), ANY(HAS("w2wonderseed"), smbw_cat(1, "daisy", "yellowtoad", "bluetoad", "toadette"))) end
